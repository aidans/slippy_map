...
public class SlippyMapTest2 extends PApplet{
	...
	public void setup(){
		...
		LonLatBounds initialLonLatArea=new LonLatBounds(-0.13183631,51.53467,-0.08562325,51.51638);
...
//		slippyMap.setMapType(SlippyMapType.STAMEN_WATERCOLOUR);
	...
	public void keyPressed(){
		...
		if (key=='x')
			slippyMap.setTilePixelWidth(60);
	}	
